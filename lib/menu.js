 ...
 * əsas menyuda və digər ekranlarda göstərilmir. ⛔ Prosesi ləğv et hər yerdə
 * .cc ilə eyni işi görür (aktiv prosesi dayandırır, müvəqqəti məlumatları
 * təmizləyir, əsas menyuya qaytarır).
 */
const MAIN_MENU_BUTTONS = [
  ...
  [{ text: '⛔ Prosesi ləğv et', callback_data: 'cc' }],
];
